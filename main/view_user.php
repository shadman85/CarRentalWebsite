    ...
    <div class="row ">
       ...
       <div class="col-sm-2">
         ...
         <div class="col-sm-8 pt-4 mt-4 border border=success">
            <h2 class="text-center m-2 p-2 "><?php echo $_GET[""] Information </h2>
         <?php     
                ...
                { ?>
                    ...
                    while($row=mysqli_fetch_assoc($result)){
                        ...
                        <tr>
                            ...
                            <td> 
                                <span class="btn btn-success"> <a href="view_user.php?viewid=<?php echo $id;?>" class="text-white text-decoration-none">View Details </a></span>
