  ...
  <nav class="navbar navbar-expand-sm bg-dark navbar-dark">                
                <a href="RentService_page.php" class="navbar-brand">
                    ...
                    <ul class="navbar-nav " >
                        ...
                        <li class="nav-item active"><a class="nav-link" href="sortbyrating.php">Sort by Rating</a></li>
                        <li class="nav-item active"><a class="nav-link" href="sortbycost.php">Sort by Cost</a></li>
                ...
                { ?>
                    ...
                    while($row=mysqli_fetch_assoc($result)){
                        ...
                        <tr>
                             ...
                             <td>
                              <form action="calc_rate.php?rateid=<?php echo $id;?>" method="post"> 
                                <input type="number" min="0" max="5" name="inputRate" > 
                            <button   type="submit" name="ok" style="background-color:green;">Rate </button> 
                            </form>
                            </td>
